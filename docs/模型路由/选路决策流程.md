...
- API 路径、鉴权与响应 envelope 见 [OpenAPI](../接口契约/router.openapi.yaml)
- 端点协议差异见 [端点协议.md](端点协议.md)
- 供应商、渠道、分组边界分别见 [供应商规范.md](../模型渠道/供应商规范.md)、[渠道规范.md](../模型渠道/渠道规范.md)、[分组规范.md](../访问控制/分组规范.md)
